...
class WsUniteController extends AbstractController
{
    ...
    {
       //je récupère l'id de l'unité en question pour calculer le nombre de membre
       ...
       // Utiliser la méthode du repository pour obtenir le nombre de membres
       $nombreMembres = $sectionRepository->countMembersByUnite($id);
       $branches = $sectionRepository->membresParBrancheDansUnite($id);

       // Passer l'unité et le nombre de membres à la vue
